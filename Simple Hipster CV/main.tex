...
\simpleheader{headercolour}{Jorge}{Orellana B.}{Gestor Académico y TI}{white}
...
\small
\section*{Curriculum Corto}


\begin{tabular}{r| p{0.4\textwidth} c}

    \cvevent{2018--2021}{Subdirector Gestión de Pregrado}{Líder}{College UC \color{cvred}}{Finally got the goddamn ship back.\lorem\lorem\lorem}{PUC_Logo_3.png} \\
    \cvevent{2011--2021}{Director de Carreras de Informática}{Líder}{DUOC UC, Sede Puente Alto \color{cvred}}{Found a secret treasure, lost the ship. \lorem\lorem}{Logo_DUOC-UC_fondo_transparente_3.png}
