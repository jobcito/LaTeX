...
\begin{tabular}{r| p{0.4\textwidth} c}
    ...
    \cvevent{2011--2021}{Director de Carreras de Informática}{Lider}{DUOC UC, Sede Puente Alto \color{cvred}}{Found a secret treasure, lost the ship. \lorem\lorem}{Logo_DUOC-UC_edited.jpg}
\end{tabular}
\vspace{3em}
