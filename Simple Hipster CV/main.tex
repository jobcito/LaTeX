...
\simpleheader{headercolour}{Jorge}{Orellana}{Gestor Académico y TI}{white}
...
\begin{tabular}{r| p{0.4\textwidth} c}
    \cvevent{2018--2021}{Subdirector de Gestión Docente}{Líder}{College UC \color{cvred}}{Finally got the goddamn ship back.\lorem\lorem\lorem}{Universidad-Catolica-de-Chile-Logo-Vector.svg-.png} \\
    \cvevent{2011--2021}{Director de Carreras de Informática}{Líder}{DUOC UC, Sede Puente Alto \color{cvred}}{Found a secret treasure, lost the ship. \lorem\lorem}{Logo_DUOC-UC_edited.png}
\end{tabular}
\vspace{3em}
