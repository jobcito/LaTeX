...
\simpleheader{headercolour}{Jorge}{Orellana B.}{Experto en Gestión Académica y Tecnológica}{white}
...
\flushright
\begin{center}
    \roundpic{Foto Sitio Web College_4k_edited.jpg}
\end{center}

\bg{cvgreen}{white}{Perfil}\\[0.5em]

{\footnotesize
Profesional de la gestión y la tecnología que se
especializa en la busqueda y 
entrega del mejor
servicio en la organización, usando un conocimiento
amplio y profundo del negocio.}
\bigskip

\bg{cvgreen}{white}{personal} \\[0.5em]
Jorge Orellana Briones
...
Líder de Equipos ~•~ Gestión Académica ~•~  Gestión Tecnológica ~•~ Educación Superior
...
\texttt{AI} ~/~ \texttt{IBM Cognos} ~/~ \texttt{Banner}

\texttt{Office365} ~/~ \texttt{Cloud} ~/~ \texttt{SaaS}

\texttt{LMSs} ~/~ \texttt{ERPs} ~/~ \texttt{Linux}

\vspace{4em}

%\infobubble{\faAt}{cvgreen}{white}{jorge.orellana.cl@outlook.com}
\infobubble{\faTwitter}{cvgreen}{white}{@JorgeOrellanaB}
%\infobubble{\faFacebook}{cvgreen}{white}{Jack Sparrow}
\infobubble{\faGithub}{cvgreen}{white}{jobcito}
%\infobubble{\faLinkedin}{cvgreen}{white}{/in/jorge-orellana-briones-a7a5529}
...
%{\small Jorge Orellana B. \icon{\faEnvelopeO}{cvgreen}{} jorge.orellana.cl@outlook.com \icon{\faMapMarker}{cvgreen}{} Valle del Maule Sur 8154, Peñalolén, Santiago, Chile \icon{\faPhone}{cvgreen}{} +56 9 79876586 %\newline\icon{\faAt}{cvgreen}{} \protect\url{jack@sparrow.com}
%}
{\small \icon{\faEnvelopeO}{cvgreen}{} jorge.orellana.cl@outlook.com \icon{\faMapMarker}{cvgreen}{} Valle del Maule Sur 8154, Peñalolén, Santiago, Chile \newline \icon{\faPhone}{cvgreen}{} +56 9 79876586 \icon{\faLinkedin}{cvgreen}{} /in/jorge-orellana-briones-a7a5529
}
\end{center}
\end{minipage}
